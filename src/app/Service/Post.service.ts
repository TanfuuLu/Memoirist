...
export class PostService {
  ...
  editContextPost(postId: number,newContext: string): Observable<Post>{
    const params = { newContext: newContext};
    return this.http.put<Post>(`${this.postApiUrl}/update-context-${postId}`,null, {params});
  }
